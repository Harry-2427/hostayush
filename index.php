      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="btn btn-primary ml-lg-3" href="html/login.php">Take test</a>
            </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(assets/img/bg_ayush.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <a href="html/login.php" class="btn btn-primary">Know Your Prakriti</a>
      </div>
    </div>
  </div>
  ...
  <div class="page-section">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 py-3 wow fadeInUp" id="about">
          <h1>Welcome to Your Health <br> Center</h1>
          <p class="text-grey mb-4">Health and wellness depend on a delicate balance between the mind, body, and spirit.In Indian Ayurveda, there are mainly three types of body types—Vata, Pitta & Kapha. The doshas are described as biological energies found throughout the human body and mind. They govern the physical and mental processes and provide every living being with an individual blueprint for health and fulfillment.The body type of a person depends on their physical and emotional attributes. To get the maximum benefit from the daily diet you consume or treatment you take when ill you must know your body type.</p>
